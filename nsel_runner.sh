...
for ((i=0;i<${#dataarray[@]};++i)); do
	...
	# Make sbatch runfile
	echo "#!/bin/bash
#SBATCH -J nsel_${cur_data}_${rank}            # job name
#SBATCH -o nsel_${cur_data}_${rank}.o        # output and error file name (%j expands to jobID)
...
matlab -r \"set_local_env; run_N_experiments('${cur_data}',${cur_bw},${cur_reg},${rank} ); quit\"  
