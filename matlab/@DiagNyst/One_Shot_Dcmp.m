function [U,l,varargout] = One_Shot_Dcmp(Diag,bnum)
...
smpIdx = get_idx(y,Diag.smp); %draws proportionally to class sizes
...
% Compute kernel
xSub = x(smpIdx,:);
K_nm = feval(Diag.kernelfun,x,xSub);
